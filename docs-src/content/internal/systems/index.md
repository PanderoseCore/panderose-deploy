...
Architecture and local-dev docs for Panderose's own internal systems and
shared libraries — not published products (those live under
[public Products](/products) when they have a public-facing counterpart).
See the [classification policy](/internal/standards/classification) for
